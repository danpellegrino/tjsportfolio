    ...
    return (
        <Card className='group overflow-hidden relative'>
            <CardHeader className='p-0'>
                {/* image */}
                {project.image &&
                    <div className='relative w-full xxl:h-[570px] xl:h-[400px] flex items-center justify-center bg-primary/15 dark:bg-secondary/20 xl:bg-work_project_bg_light xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow-hidden'>
                        <Image
